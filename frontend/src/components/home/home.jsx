      ...
      <div className="v-container">
        <div className="problem">
          <div className="problem-name">
            <h1 className="cb title">Hello World</h1>
            <div className="available-languages">
              ...
              <svg
                width="50"
                height="50"
                viewBox="0 0 306 344.4"
                style={{ marginLeft: "1rem" }}
              >
                <path
                  d="M302.1 258.3c2.4-4.2 3.9-8.8 3.9-13.1V99.1c0-4.2-1.5-8.9-3.9-13.1L153 172.2 302.1 258.3z"
                  fill="#00599C"
                />
                <path
                  d="M166.3 341.2l126.5-73c3.6-2.1 7-5.7 9.4-9.9L153 172.2 3.9 258.3c2.4 4.2 5.7 7.8 9.4 9.9l126.5 73C147 345.4 159 345.4 166.3 341.2z"
                  fill="#004482"
                />
                <path
                  d="M302.1 86.1c-2.4-4.2-5.7-7.8-9.4-9.9L166.3 3.2c-7.3-4.2-19.2-4.2-26.5 0L13.3 76.2C6 80.4 0 90.7 0 99.1v146.1c0 4.2 1.5 8.9 3.9 13.1L153 172.2 302.1 86.1z"
                  fill="#659AD2"
                />
                <path
                  d="M153 274.2c-56.2 0-102-45.8-102-102s45.8-102 102-102c36.3 0 70.1 19.5 88.3 51l-44.1 25.5c-9.1-15.7-26-25.5-44.2-25.5 -28.1 0-51 22.9-51 51 0 28.1 22.9 51 51 51 18.2 0 35.1-9.8 44.2-25.5l44.1 25.5C223.1 254.6 189.3 274.2 153 274.2z"
                  fill="#FFF"
                />
                <polygon
                  points="255 166.5 243.7 166.5 243.7 155.2 232.3 155.2 232.3 166.5 221 166.5 221 177.8 232.3 177.8 232.3 189.2 243.7 189.2 243.7 177.8 255 177.8 "
                  fill="#FFF"
                />
                <polygon
                  points="297.5 166.5 286.2 166.5 286.2 155.2 274.8 155.2 274.8 166.5 263.5 166.5 263.5 177.8 274.8 177.8 274.8 189.2 286.2 189.2 286.2 177.8 297.5 177.8 "
                  fill="#FFF"
                />
              </svg>
              {/* CSharp */}
                ...
                <defs>
                  <style
                    dangerouslySetInnerHTML={{
                      __html: ".cls-1{fill:#fff;}.cls-2{fill:#007acc;}",
                    }}
                  ></style>
                </defs>
              ...
              >
                <style
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      ".st0{fill:#463B63;}.st1{fill:#5E5187;}.st2{fill:#904F8C;}",
                  }}
                ></style>
                <path
                  className="st0"
          ...
          <div className="h-container">
            <div className="problem-tags">
              <span className="problem-tag">Easy</span>
              <span className="problem-tag">Beginner</span>
            </div>
            <div className="problem-reaction">
              <button className="problem-reaction-button">
                <box-icon name="like" color="white" size="2rem" />
              </button>
              <button className="problem-reaction-button">
                <box-icon name="dislike" color="white" size="2rem" />
              </button>
              <div className="problem-reaction-bar">
                <div
                  className="problem-reaction-bar-child-1"
                  style={reactionBarStyle.c1}
                ></div>
                <div
                  className="problem-reaction-bar-child-2"
                  style={reactionBarStyle.c2}
                ></div>
              </div>
